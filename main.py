...
#simple model with random weight
...
if __name__ == "__main__":
    ...
    print("***********PERFORMANCE TESTING FOR RANDOM FUNCTION*************")
    ...
    model_nn()
    model.summary()
    history=model.fit(x_train, y_train,batch_size=200, epoch =100,verbase= 1)
    print("***********PERFORMANCE TESTING FOR TENSERFLOW*************")
    print(history)